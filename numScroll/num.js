(function($) {
  $.fn.numberAnimate = function(setting) {
    ...
    var nHtml = '<div class="number-animate-dom" data-num="{{num}}">\
    ...
    var setNumDom = function(arrStr){
      ...
      for(var i=0,len=arrStr.length; i<len; i++){
        if(i != 0 && (len-i)%3 == 0 && setting.symbol != "" && arrStr[i]!="."){
          shtml += '<div class="number-animate-dot">'+setting.symbol+'</div>'+nHtml.replace("{{num}}",arrStr[i]);
        }else{
    ...
    var runAnimate = function($parent){
      $parent.find(".number-animate-dom").each(function() {
    ...
    this.resetData = function(num){
      ...
      var $dom = $(this).find(".number-animate-dom");
